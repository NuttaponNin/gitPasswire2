        ...
        <section class="wrapper">              
            <div class="row">
                <div class="col-lg-9 main-chart">
                    <h3><i class="fa fa-angle-right"></i> Your Note Information</h3>
                    <?php                            
                            // include("connect.php");
                            ...
                            $data = mysql_query("SELECT * FROM `storednote` WHERE noteID = '"
                                    . mysql_real_escape_string($passDataId) . "'")
                                    or die(mysql_error());
                            while ($info = mysql_fetch_array($data)) {
                              ...
                              <table style="font-size: medium;margin-left: 20px;">
                                ...
                                <tr>
                                  <td>Description</td>
                                  <td>&nbsp;: <?=$decrypted_description?></td>
                                </tr>
                                <tr>
                                  <td>Content</td>
                                  <td>&nbsp;: <?=$decrypted_content?></td>
                                </tr>
                                <tr>
                                  <td>Update</td>
