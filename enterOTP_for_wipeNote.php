        ...
        <section class="wrapper">              
            <div class="row">
                <div class="col-lg-9 main-chart">
                    <h3><i class="fa fa-angle-right"></i> ENTER OTP FOR WIPE NOTE</h3>
                    <form class="form-signin" method="post" action="otpcheck_for_wipeNote.php">
                        <input type="text" name="yourotp" class="form-control" required autofocus><br>
                        <?php
                          echo '<input type="hidden" name="accountId" value="'.$_GET["noteId"].'"/>';
                        ?>
