              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          ...
                          <li class="active"><a  href="viewNote.php">Note</a></li>
                      </ul>
                  </li>
        ...
        <section class="wrapper">              
            <div class="row">
                <div class="col-lg-9 main-chart">
                    <h3><i class="fa fa-angle-right"></i> View Note Information</h3>
                          ...
                          <table class="table table-striped table-advance table-hover">	                  	  	  
                            ...
                            ?>
                              ...
                              <tr>
                                  ...
                                  <?php $content = "click item to show content"?>
                                  <td><?=$content?></td>                                  
                                  
                                  <?php $description = "cilk item to show"?>
                                        <td><?=$description?></td>
                                  <td>
                                      <button type="button" class="btn btn-success btn-xs" data-toggle="modal" data-target="#popCheckPass" onclick="viewButtonOnClick(<?=$info['noteID']?>)"><i class="fa fa-search"></i></button>
                                  </td>                                        
                              </tr>
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              <div class="modal-header" style="background-color: #ed8824 ">
                ...
                <h4 class="modal-title" id="myModalLabel">View Note Information</h4>
              </div>

              <div class="row">
                <div class="col-sm-6 col-md-6 col-md-offset-2">
                    <h5><b> Please comfirm your master password</b></h5>
                      <form class="form-signin" method="post" action="checkMasterPasswordForShowNote.php">
            ...
            success: function(data) {
             ...
             switch(cmd){
              ...
              case 1:
                ...
                window.location = 'showNoteInformation.php?passDataId='+document.getElementById('txtPassDataId').value;
                break;
              default:
...
<!-- END About Function Graphical MasterPassword -->  
    ...
    <!-- Modal #popInformationNote -->
    <div class="modal fade" id="popInformationNote" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
      <div class="modal-dialog" role="document">
    ...
    <script type="text/javascript">
      function viewButtonOnClick(accountID){
        ...
        $.ajax({
            ...
            url: '/passwire/showNoteInformation.php',
            data: dataPost,
            async: false,
