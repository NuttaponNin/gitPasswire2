        ...
        <section class="wrapper">              
            <div class="row">
                <div class="col-lg-9 main-chart">
                    <h3><i class="fa fa-angle-right"></i> Wipe Password</h3>
                    <div class="row mt">                        
                    <div class="col-md-12">
                          ...
                          <table class="table table-striped table-advance table-hover">	                  	  	  
                            ...
                            ?>
                                    <tr>                                                                           
                                        ...
                                        <?php $username = "show in view information"?>
                                        <td><?=$username?></td> 
                                        ...
                                        <td><?=$description?></td>
                                        <td>
                                            <button type="button" class="btn btn-danger btn-xs" data-toggle="modal" data-target="#popCheckPass" onclick="viewButtonOnClick(<?=$info['accountID']?>)">
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              <div class="modal-header" style="background-color: #ed8824 ">
                ...
                <h4 class="modal-title" id="myModalLabel">Wipe Password</h4>
              </div>

              <div class="row">
                <div class="col-sm-6 col-md-6 col-md-offset-2">
                    <h5><b> Please comfirm your master password</b></h5>
                      <form class="form-signin" method="post" action="checkMasterPasswordForWipeData.php">
                          ...
                          <p> Your password information will be deleted from the server.</p>
            ...
            success: function(data) {
             ...
             switch(cmd){
              ...
              case 1:
                ...
                window.location = 'sendMail_for_wipeData.php?graphic='+password+'&accountId='+document.getElementById('txtPassDataId').value;
                break;
              default:
